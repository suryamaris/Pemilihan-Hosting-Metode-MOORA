...
class Data_model extends CI_Model
{
	...
	public function Input()
	{
		...
		if ($this->input->post('add') != 'tidak')
			$fitur += array('add' => 'Free ' . $this->input->post('add') . ' Addon Domain');
		if ($this->input->post('sub') != 'tidak')
			$fitur += array('sub' => 'Free ' . $this->input->post('sub') . ' Sub Domain');
	...
	public function update_data()
	{
		...
		$data = array(
			'id' => $this->input->post('id'), 'nama' => $this->input->post('nama'), 'penyedia' => $this->input->post('penyedia'), 'uptime' => $this->input->post('uptime'), 'ssd' => $ssd, 'ram' => $this->input->post('ram'), 'cpu' => $this->input->post('cpu'), 'bandwith' => $bandwith, 'inode' => $inode, 'support' => $this->input->post('support'), 'wordpress' => $this->input->post('wordpress'), 'fitur' => $myFitur, 'garansi' => $this->input->post('garansi'), 'harga' => $this->input->post('harga'), 'keamanan' => $this->input->post('Keamanan')
		);
		return $data;
	}
	...
	public function updateNilai()
	{
		...
		if ($support == 'Fast Support 24/7')
			...
			$support = 3;
		$dataNilai = array(
			'id' => $this->input->post('id'), 'keamanan' => $this->input->post('jumlah'), 'uptime' => $this->input->post('uptime'), 'ssd' => $ssd, 'ram' => $this->input->post('ram'), 'cpu' => $this->input->post('cpu'), 'bandwith' => $bandwith, 'inode' => $inode, 'support' => $support, 'fitur' => $fitur, 'garansi' => $this->input->post('garansi'), 'harga' => $this->input->post('harga')
		);
		return $dataNilai;
	}
}
