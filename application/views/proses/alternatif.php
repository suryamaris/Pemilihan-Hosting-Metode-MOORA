...
<div class="tab">
    <div class="btn-group" role="group" aria-label="Basic outlined example">
        <a class="nav-link active" href='<?= base_url('datahosting/proses') ?>'> <button type="button" class="btn btn-outline-primary">Alternatif</button></a>
...
<div class="data">
    <h3 style="text-align: center;">Nilai Alternatif</h3>
