				...
				<table>
					<form method="post" action="<?php echo base_url('update'); ?>">
						...
						<tr>
							...
							<td></td>
							<td>SSD </td>
							<td>:<input type="radio" name="fiturSSD" value="ya"> Ya
								<input type="radio" name="fiturSSD" value="tidak"> Tidak
							</td>
						</tr>
						<tr>
							<td></td>
						...
						<tr>
							...
							<td></td>
							<td>Domain Gratis </td>
							<td>:<input type="radio" name="domain" value="Terbatas"> Terbatas
						...
						<tr>
							...
							<td></td>
							<td>Email</td>
							<td>:<input type="radio" name="email" value="Terbatas"> Terbatas
						...
						<tr>
							...
							<td></td>
							<td>Addon Domain</td>
							<td>:<input type="radio" name="add" value="Terbatas"> Terbatas
